...
# Optional since we already added the helm provider (just to make it self contained)
...
# kubernetes provider to create a custom kubernetes storage class for EFS
